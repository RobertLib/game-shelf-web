...
describe("Auth utility functions", () => {
  ...
  describe("clearAuthAndRedirect", () => {
    it("should clear auth data and redirect when tokens exist", () => {
      mockLocalStorage.getItem.mockImplementation((key) => {
    ...
    it("should not redirect when no auth data exists", () => {
      mockLocalStorage.getItem.mockReturnValue(null);
    ...
    it("should redirect when only token exists", () => {
      mockLocalStorage.getItem.mockImplementation((key) => {
        if (key === "token") return "token";
        return null;
      });
    ...
    it("should redirect when only refresh token exists", () => {
      mockLocalStorage.getItem.mockImplementation((key) => {
        if (key === "refreshToken") return "refreshToken";
        return null;
      });
    ...
    it("should redirect when only session exists", () => {
      mockLocalStorage.getItem.mockImplementation((key) => {
        if (key === "session") return "session";
        return null;
      });
