...
describe("Autocomplete Component", () => {
  ...
  it("handles value clearing and null/empty states", () => {
    ...
    rerenderWithProviders(
      <MockedProvider mocks={[]}>
        <Autocomplete options={mockOptions} value={null} />
      </MockedProvider>,
    );
    expect(screen.getByRole("combobox")).toHaveValue("");
    ...
    rerenderWithProviders(
      <MockedProvider mocks={[]}>
        <Autocomplete options={mockOptions} value="" />
      </MockedProvider>,
    );
    expect(screen.getByRole("combobox")).toHaveValue("");
  });
  ...
  it("handles data path parsing correctly", async () => {
    ...
    renderWithProviders(
      <MockedProvider mocks={nestedMocks}>
        <Autocomplete
          query={mockQuery}
          variables={mockVariables}
  ...
  it("handles search debouncing in GraphQL mode", async () => {
    const mocks = [
      {
        request: {
          query: mockQuery,
  ...
  it("handles GraphQL pagination with cursor", async () => {
    ...
    renderWithProviders(
      <MockedProvider mocks={[firstPageMock, secondPageMock]}>
        <Autocomplete
          query={mockQuery}
          variables={mockVariables}
          dataPath="users"
  ...
  it("handles complex dataPath with multiple levels", async () => {
    ...
    renderWithProviders(
      <MockedProvider mocks={[complexMock]}>
        <Autocomplete
          query={mockQuery}
          variables={mockVariables}
  ...
  it("handles email fallback when name is not available", async () => {
    ...
    renderWithProviders(
      <MockedProvider mocks={[emailMock]}>
        <Autocomplete
          query={mockQuery}
          variables={mockVariables}
          dataPath="users"
  ...
  it("handles select mode with GraphQL data", async () => {
    ...
    renderWithProviders(
      <MockedProvider mocks={[selectMock]}>
        <Autocomplete
          query={mockQuery}
          variables={mockVariables}
          dataPath="users"
  ...
  it("handles cursor initialization and update correctly", async () => {
    ...
    renderWithProviders(
      <MockedProvider mocks={[initialMock]}>
        <Autocomplete
          query={mockQuery}
          variables={mockVariables}
          dataPath="users"
